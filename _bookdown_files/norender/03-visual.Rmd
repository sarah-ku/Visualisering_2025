...
ggplot(data=BOD,aes(x=Time,y=demand)) + geom_line() + theme_bw() +
  xlab("Time") + ylab("Biochemical oxygen demand") + ggtitle("Plot showing BOD over time")
```
...
ggplot(data=CO2_subset,aes(x=conc,y=uptake,group=Plant,colour=Treatment)) + 
  geom_line() + theme_bw() + xlab("Ambient carbon dioxide concentration") + ylab("Carbon dioxide uptake")
```
